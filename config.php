<?php
	...
	$dbUsername = 'root';
	$dbPassword = '';
	$dbDatabase = 'Tadika-Anakku-Gemilang';
	$appURI = 'Tadika-Anakku-Gemilang';
	$host = 'localhost';

	$adminConfig = array(
		'adminUsername' => "admin",
		'adminPassword' => "\$2y\$10\$77S4tU0aE5rGi.FzBW2/9O9cNPhU9RUijVmSVahg4IgZKkBXy0PPe",
