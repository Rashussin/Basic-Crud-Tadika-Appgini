...
function order_details_insert(){
	...
	sql('insert into `order_details` set       `OrderID`=' . (($data['OrderID'] !== '' && $data['OrderID'] !== NULL) ? "'{$data['OrderID']}'" : 'NULL') . ', `ProductID`=' . (($data['ProductID'] !== '' && $data['ProductID'] !== NULL) ? "'{$data['ProductID']}'" : 'NULL') . ', `Category`=' . (($data['Category'] !== '' && $data['Category'] !== NULL) ? "'{$data['Category']}'" : 'NULL') . ', `CatalogPrice`=' . (($data['CatalogPrice'] !== '' && $data['CatalogPrice'] !== NULL) ? "'{$data['CatalogPrice']}'" : 'NULL') . ', `UnitsInStock`=' . (($data['UnitsInStock'] !== '' && $data['UnitsInStock'] !== NULL) ? "'{$data['UnitsInStock']}'" : 'NULL') . ', `UnitPrice`=' . (($data['UnitPrice'] !== '' && $data['UnitPrice'] !== NULL) ? "'{$data['UnitPrice']}'" : 'NULL') . ', `Quantity`=' . (($data['Quantity'] !== '' && $data['Quantity'] !== NULL) ? "'{$data['Quantity']}'" : 'NULL') . ', `Discount`=' . (($data['Discount'] !== '' && $data['Discount'] !== NULL) ? "'{$data['Discount']}'" : 'NULL'), $o);
	if($o['error']!=''){
		echo $o['error'];
