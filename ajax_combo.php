...
*/
	...
	$lookups = array(   
		...
		'cikgu' => array(   
			'ditambahOleh' => array(
				'parent_table' => 'admin',
				'parent_pk_field' => 'adminID',
				'parent_caption' => '`admin`.`nama`',
				'parent_from' => '`admin` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
		...
		'pelajar' => array(   
			'subjek' => array(
				'parent_table' => 'Subjek',
				'parent_pk_field' => 'subjekID',
				'parent_caption' => 'IF(CHAR_LENGTH(`Subjek`.`subjekKode`) || CHAR_LENGTH(`Subjek`.`subjekNama`), CONCAT_WS(\'\', `Subjek`.`subjekKode`, \' - \', `Subjek`.`subjekNama`), \'\')',
				'parent_from' => '`Subjek` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
			...
			'subjekID' => array(
				'parent_table' => 'Subjek',
				'parent_pk_field' => 'subjekID',
				'parent_caption' => '`Subjek`.`subjekNama`',
				'parent_from' => '`Subjek` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
