	...
	*/
	...
	$schema = array(   
		'customers' => array(   
			...
			'TotalSales' => array('appgini' => 'DOUBLE(10,2) ')
		),
		'employees' => array(   
		...
		'orders' => array(   
			...
			'status' => array('appgini' => 'VARCHAR(200) '),
			...
			'total' => array('appgini' => 'DECIMAL(10,2) ')
		),
		'order_details' => array(   
			...
			'CatalogPrice' => array('appgini' => 'INT '),
			'UnitsInStock' => array('appgini' => 'INT '),
			...
			'Subtotal' => array('appgini' => 'DOUBLE(10,2) ')
		),
		'products' => array(   
		...
		'shippers' => array(   
			...
			'Phone' => array('appgini' => 'VARCHAR(24) '),
			'NumOrders' => array('appgini' => 'INT ')
		),
		'admin' => array(   
			'adminID' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'nama' => array('appgini' => 'VARCHAR(40) '),
			'email' => array('appgini' => 'VARCHAR(80) '),
			'phone' => array('appgini' => 'VARCHAR(40) ')
		),
		'cikgu' => array(   
			'cikguID' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'nama' => array('appgini' => 'VARCHAR(40) '),
			'email' => array('appgini' => 'VARCHAR(80) '),
			'phone' => array('appgini' => 'VARCHAR(40) '),
			'alamat' => array('appgini' => 'VARCHAR(40) '),
			'ditambahOleh' => array('appgini' => 'INT unsigned '),
			'adminID' => array('appgini' => 'INT unsigned ')
		),
		'pelajar' => array(   
			'pelajarID' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'nama' => array('appgini' => 'VARCHAR(40) '),
			'umur' => array('appgini' => 'VARCHAR(40) '),
			'alamat' => array('appgini' => 'VARCHAR(40) '),
			'subjek' => array('appgini' => 'INT unsigned '),
			'statusYuran' => array('appgini' => 'VARCHAR(40) default \'Belum Bayar\' '),
			'ditambahOleh' => array('appgini' => 'INT unsigned '),
			'adminID' => array('appgini' => 'INT unsigned '),
			'subjekID' => array('appgini' => 'INT unsigned ')
		),
		'Subjek' => array(   
			'subjekID' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'subjekKode' => array('appgini' => 'VARCHAR(40) '),
			'subjekNama' => array('appgini' => 'VARCHAR(40) '),
			'subjekDescription' => array('appgini' => 'LONGTEXT ')
		)
	);
