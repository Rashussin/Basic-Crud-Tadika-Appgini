...
// admin table
admin_addTip=["",spacer+"This option allows all members of the group to add records to the 'Admin' table. A member who adds a record to the table becomes the 'owner' of that record."];

admin_view0Tip=["",spacer+"This option prohibits all members of the group from viewing any record in the 'Admin' table."];
admin_view1Tip=["",spacer+"This option allows each member of the group to view only his own records in the 'Admin' table."];
admin_view2Tip=["",spacer+"This option allows each member of the group to view any record owned by any member of the group in the 'Admin' table."];
admin_view3Tip=["",spacer+"This option allows each member of the group to view all records in the 'Admin' table."];

admin_edit0Tip=["",spacer+"This option prohibits all members of the group from modifying any record in the 'Admin' table."];
admin_edit1Tip=["",spacer+"This option allows each member of the group to edit only his own records in the 'Admin' table."];
admin_edit2Tip=["",spacer+"This option allows each member of the group to edit any record owned by any member of the group in the 'Admin' table."];
admin_edit3Tip=["",spacer+"This option allows each member of the group to edit any records in the 'Admin' table, regardless of their owner."];

admin_delete0Tip=["",spacer+"This option prohibits all members of the group from deleting any record in the 'Admin' table."];
admin_delete1Tip=["",spacer+"This option allows each member of the group to delete only his own records in the 'Admin' table."];
admin_delete2Tip=["",spacer+"This option allows each member of the group to delete any record owned by any member of the group in the 'Admin' table."];
admin_delete3Tip=["",spacer+"This option allows each member of the group to delete any records in the 'Admin' table."];

// cikgu table
cikgu_addTip=["",spacer+"This option allows all members of the group to add records to the 'Cikgu' table. A member who adds a record to the table becomes the 'owner' of that record."];

cikgu_view0Tip=["",spacer+"This option prohibits all members of the group from viewing any record in the 'Cikgu' table."];
cikgu_view1Tip=["",spacer+"This option allows each member of the group to view only his own records in the 'Cikgu' table."];
cikgu_view2Tip=["",spacer+"This option allows each member of the group to view any record owned by any member of the group in the 'Cikgu' table."];
cikgu_view3Tip=["",spacer+"This option allows each member of the group to view all records in the 'Cikgu' table."];

cikgu_edit0Tip=["",spacer+"This option prohibits all members of the group from modifying any record in the 'Cikgu' table."];
cikgu_edit1Tip=["",spacer+"This option allows each member of the group to edit only his own records in the 'Cikgu' table."];
cikgu_edit2Tip=["",spacer+"This option allows each member of the group to edit any record owned by any member of the group in the 'Cikgu' table."];
cikgu_edit3Tip=["",spacer+"This option allows each member of the group to edit any records in the 'Cikgu' table, regardless of their owner."];

cikgu_delete0Tip=["",spacer+"This option prohibits all members of the group from deleting any record in the 'Cikgu' table."];
cikgu_delete1Tip=["",spacer+"This option allows each member of the group to delete only his own records in the 'Cikgu' table."];
cikgu_delete2Tip=["",spacer+"This option allows each member of the group to delete any record owned by any member of the group in the 'Cikgu' table."];
cikgu_delete3Tip=["",spacer+"This option allows each member of the group to delete any records in the 'Cikgu' table."];

// pelajar table
pelajar_addTip=["",spacer+"This option allows all members of the group to add records to the 'Pelajar' table. A member who adds a record to the table becomes the 'owner' of that record."];

pelajar_view0Tip=["",spacer+"This option prohibits all members of the group from viewing any record in the 'Pelajar' table."];
pelajar_view1Tip=["",spacer+"This option allows each member of the group to view only his own records in the 'Pelajar' table."];
pelajar_view2Tip=["",spacer+"This option allows each member of the group to view any record owned by any member of the group in the 'Pelajar' table."];
pelajar_view3Tip=["",spacer+"This option allows each member of the group to view all records in the 'Pelajar' table."];

pelajar_edit0Tip=["",spacer+"This option prohibits all members of the group from modifying any record in the 'Pelajar' table."];
pelajar_edit1Tip=["",spacer+"This option allows each member of the group to edit only his own records in the 'Pelajar' table."];
pelajar_edit2Tip=["",spacer+"This option allows each member of the group to edit any record owned by any member of the group in the 'Pelajar' table."];
pelajar_edit3Tip=["",spacer+"This option allows each member of the group to edit any records in the 'Pelajar' table, regardless of their owner."];

pelajar_delete0Tip=["",spacer+"This option prohibits all members of the group from deleting any record in the 'Pelajar' table."];
pelajar_delete1Tip=["",spacer+"This option allows each member of the group to delete only his own records in the 'Pelajar' table."];
pelajar_delete2Tip=["",spacer+"This option allows each member of the group to delete any record owned by any member of the group in the 'Pelajar' table."];
pelajar_delete3Tip=["",spacer+"This option allows each member of the group to delete any records in the 'Pelajar' table."];

// Subjek table
Subjek_addTip=["",spacer+"This option allows all members of the group to add records to the 'Subjek' table. A member who adds a record to the table becomes the 'owner' of that record."];

Subjek_view0Tip=["",spacer+"This option prohibits all members of the group from viewing any record in the 'Subjek' table."];
Subjek_view1Tip=["",spacer+"This option allows each member of the group to view only his own records in the 'Subjek' table."];
Subjek_view2Tip=["",spacer+"This option allows each member of the group to view any record owned by any member of the group in the 'Subjek' table."];
Subjek_view3Tip=["",spacer+"This option allows each member of the group to view all records in the 'Subjek' table."];

Subjek_edit0Tip=["",spacer+"This option prohibits all members of the group from modifying any record in the 'Subjek' table."];
Subjek_edit1Tip=["",spacer+"This option allows each member of the group to edit only his own records in the 'Subjek' table."];
Subjek_edit2Tip=["",spacer+"This option allows each member of the group to edit any record owned by any member of the group in the 'Subjek' table."];
Subjek_edit3Tip=["",spacer+"This option allows each member of the group to edit any records in the 'Subjek' table, regardless of their owner."];

Subjek_delete0Tip=["",spacer+"This option prohibits all members of the group from deleting any record in the 'Subjek' table."];
Subjek_delete1Tip=["",spacer+"This option allows each member of the group to delete only his own records in the 'Subjek' table."];
Subjek_delete2Tip=["",spacer+"This option allows each member of the group to delete any record owned by any member of the group in the 'Subjek' table."];
Subjek_delete3Tip=["",spacer+"This option allows each member of the group to delete any records in the 'Subjek' table."];
